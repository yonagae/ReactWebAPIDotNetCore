...
namespace FinBY.Tests.Entities
{
    ...
    public class TransactionValidationTest
    {
        ...
        {
            Transaction transaction = new Transaction(1, 1, new DateTime(2022, 01, 12), "Continente Gaia", "Continente", _transactionAmounts, 11.0m);
        ...
        {
            Transaction transaction = new Transaction(1, 1, new DateTime(2022, 01, 12), "Continente Gaia", "Continente", new List<TransactionAmount>(), 11.0m);
        ...
        {
            Transaction transaction = new Transaction(1, 1, new DateTime(2022, 01, 12), null, "Continente", _transactionAmounts, 11.0m);
        ...
        public void Validate_InvalidDescription_ReturnIsValidFalse()
        {
            ...
            Transaction transaction = new Transaction(1, 1, new DateTime(2022, 01, 12), invalidDescription, "Continente", _transactionAmounts, 11.0m);
        ...
        {
            Transaction transaction = new Transaction(1, 1, new DateTime(2022, 01, 12), "Continente", null, _transactionAmounts, 11.0m);
        ...
        {
            string invalidDescription = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sagittis posuere lacus eu rhoncus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum non sem vitae mauris vehicula cursus. Pellentesque volutpat turpis quam, in luctus ante dignissim at. Sed efficitur, sapien eu sollicitudin mattis, augue est ornare lectus, in malesuada elit ligula ut felis. Nunc tincidunt tincidunt lobortis. Maecenas ut purus rutrum, scelerisque ante eu, euismod neque. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Nullam ac tristique nulla. Etiam ex ipsum, eleifend id ultrices at, pharetra quis orci.";
            Transaction transaction = new Transaction(1, 1, new DateTime(2022, 01, 12), "Continente", invalidDescription, _transactionAmounts, 11.0m);
        ...
        {
            string invalidDescription = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sagittis posuere lacus eu rhoncus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum non sem vitae mauris vehicula cursus. Pellentesque volutpat turpis quam, in luctus ante dignissim at. Sed efficitur, sapien eu sollicitudin mattis, augue est ornare lectus, in malesuada elit ligula ut felis. Nunc tincidunt tincidunt lobortis. Maecenas ut purus rutrum, scelerisque ante eu, euismod neque. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Nullam ac tristique nulla. Etiam ex ipsum, eleifend id ultrices at, pharetra quis orci.";
            Transaction transaction = new Transaction(1, 1, new DateTime(2022, 01, 12), invalidDescription, invalidDescription, _transactionAmounts, 11.0m);
        ...
        {
            string invalidDescription = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sagittis posuere lacus eu rhoncus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum non sem vitae mauris vehicula cursus. Pellentesque volutpat turpis quam, in luctus ante dignissim at. Sed efficitur, sapien eu sollicitudin mattis, augue est ornare lectus, in malesuada elit ligula ut felis. Nunc tincidunt tincidunt lobortis. Maecenas ut purus rutrum, scelerisque ante eu, euismod neque. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Nullam ac tristique nulla. Etiam ex ipsum, eleifend id ultrices at, pharetra quis orci.";
            Transaction transaction = new Transaction(0, 1, new DateTime(2022, 01, 12), invalidDescription, invalidDescription, null, 11.0m);
