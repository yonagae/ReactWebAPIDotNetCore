...
export default function TransacationTypeForm(props) {
    ...
    const onColorChange = (newColor) => {
        setAtividade({ ...atividade, argbColor: newColor });
    }
        ...
        <>
            <form className='row g-3' onSubmit={handleSubmit}>
                ...
                <div className='col-md-12'>
                    ...
                    <HexColorPicker color={atividade.argbColor} onChange={onColorChange} />;
                </div>
